...
<html class="overflow-y ml-auto mr-auto mb-0">
    ...
    <?php include 'header.php'; ?>
        ...
        <?php
            ...
            if (((isset($_SESSION['id']) and !empty($_SESSION['id'])) or (isset($admin['id']) and !empty($admin['id']))) and (($_GET['id'] != $admin['id'] and $_SESSION['id'] == $_GET['id'] and $_SESSION['id'] == $user['id']) or $_SESSION['id'] == $admin['id'])) {
        ?>
        <!-- Content -->
                <div id="container">
                    <div class="content">
                        <form class="w-100 pt-2 pl-4 pb-0 pr-4" action="api/user/edit_profil.php" method="POST">
                            ...
                            <?php
                                ...
                                if ($user) {
                                    ...
                                    if ((isset($_SESSION['id']) and !empty($_SESSION['id'])) or (isset ($admin['id']) and !empty($admin['id'])) and (($_SESSION['id'] == $admin['id']) or ($_SESSION['id'] == $user['id'] and $_GET['id'] == $user['id']))) {
                                        echo '<div class="md-form mt-4">';
